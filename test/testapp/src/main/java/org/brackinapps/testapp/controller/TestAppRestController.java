package org.brackinapps.testapp.controller;
...
public class TestAppRestController  {
    private Logger logger = LoggerFactory.getLogger(TestAppRestController.class);

    private final JdbcTemplate jdbcTemplate;

    public TestAppRestController(JdbcTemplate jdbcTemplate) {
